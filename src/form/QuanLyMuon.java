...
import static form.QuanLyPhieuNhap.chose;
 ...
 * @author minht
 */
public class QuanLyMuon extends javax.swing.JFrame {
    List<PhieuMuonToHop> listPM = new ArrayList<>();
   DefaultTableModel tableModel = null;
   public static String choose;
   
    public void showData(){
         listPM = PhieuMuonToHopDAO.getInstance().selectAll();
    ...
    public QuanLyMuon() {
        ...
        choiceListFilter.add("Ngày mượn");
        choiceListFilter.add("Ngày hết hạn");
        ...
        choose = choiceListFilter.getItem(0);
            ...
            public void propertyChange(PropertyChangeEvent evt){
                if(choose.equalsIgnoreCase("Ngày mượn")) {
                    ...
                    listPM = PhieuMuonToHopDAO.getInstance().selectByCondition(newDate,1);
                    tableModel.setRowCount(0);
                    listPM.forEach((pm) -> {
                        tableModel.addRow(new Object[] {pm.getMaM(), pm.getHoTen(), pm.getNgayMuon(),pm.getNgayHetHan(),pm.getSoLuong(),pm.getGhiChu()});
                     });
    ...
    private void initComponents() {
        ...
        inputSearchMaM = new javax.swing.JTextField();
        ...
        phieuTraBtn = new javax.swing.JButton();
        ...
        setPreferredSize(new java.awt.Dimension(1040, 726));
        ...
        thempnBTN.setText("Thêm Phiếu Mượn");
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(inputSearchMaM, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(inputSearchMaM, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3))
                .addGap(18, 18, 18)
                .addComponent(searchBtn)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(153, 153, 153)), "Danh sách phiếu mượn", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Mượn", "Họ Tên Độc Giả", "Ngày Mượn ", "Ngày Hết Hạn", "Số Lượng", "Ghi Chú"
            }
        ));
        ...
        phieuTraBtn.setText("Quản lý phiếu trả");
        phieuTraBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                phieuTraBtnActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel10, javax.swing.GroupLayout.PREFERRED_SIZE, 1045, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(0, 0, 0)
                            .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addComponent(jPanel11, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 1045, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(0, 0, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(mainBtn)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(phieuTraBtn)
                .addGap(14, 14, 14)
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        String inputSoPn = inputSearchMaM.getText();
        if (inputSoPn.equalsIgnoreCase("")){
            JOptionPane.showMessageDialog(null, "Vui lòng Nhập Mã Mượn cần tìm");
            showData();
        }else {
        tableModel = (DefaultTableModel) table.getModel();
        tableModel.setRowCount(0);
        listPM = PhieuMuonToHopDAO.getInstance().selectByCondition(inputSoPn,9);
        tableModel.setRowCount(0);
        listPM.forEach((pm) -> {
            tableModel.addRow(new Object[] {pm.getMaM(), pm.getHoTen(), pm.getNgayMuon(),pm.getNgayHetHan(),pm.getSoLuong(),pm.getGhiChu()});
        });
    ...
    private void todayChooceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_todayChooceActionPerformed
        ...
        if(todayChooce.isSelected() && choose.equalsIgnoreCase("Ngày mượn")) {
    ...
    private void monthChooseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_monthChooseActionPerformed
        ...
        if(monthChoose.isSelected() && choose.equalsIgnoreCase("Ngày mượn")){
            tableModel = (DefaultTableModel) table.getModel();
            tableModel.setRowCount(0);
    ...
    private void choiceListFilterItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_choiceListFilterItemStateChanged
        // TODO add your handling code here:
        choose = choiceListFilter.getItem(choiceListFilter.getSelectedIndex());
    ...
    private void yearChoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yearChoiceActionPerformed
        ...
        if(yearChoice.isSelected() && choose.equalsIgnoreCase("Ngày mượn")){
            tableModel = (DefaultTableModel) table.getModel();
            tableModel.setRowCount(0);
    ...
    private void lastyearChoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lastyearChoiceActionPerformed
        ...
        if(lastyearChoice.isSelected() && choose.equalsIgnoreCase("Ngày mượn")){
            tableModel = (DefaultTableModel) table.getModel();
            tableModel.setRowCount(0);
...
//        chitietpnDialog ct = new chitietpnDialog(this, false, SoPN);
    ...
    private void thempnBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thempnBTNActionPerformed
        // TODO add your handling code here:
        QuanLyThemPM menuLyThemPM = new QuanLyThemPM();
        setVisible(false);
    }//GEN-LAST:event_thempnBTNActionPerformed

    private void phieuTraBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_phieuTraBtnActionPerformed
        // TODO add your handling code here:
        QuanLyPhieuTra mainPhieuTra = new QuanLyPhieuTra();
        setVisible(false);
    }//GEN-LAST:event_phieuTraBtnActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyMuon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField inputSearchMaM;
    ...
    private javax.swing.JButton phieuTraBtn;
